...
public class UserRights {
  ...
  public void testUserRights() throws Exception {
    ...
    assertEquals("Sign in", driver.findElement(By.cssSelector("button.btn.btn-success")).getText());
    driver.findElement(By.name("login")).clear();
    ...
    assertThat("Sign in", is(not(driver.findElement(By.cssSelector("button.btn.btn-success")).getText())));
